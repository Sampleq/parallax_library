! function (e, t) {
    ...
    var e = function (t, o) {
        ...
        var p = function (e) {
            ...
            s = t || (s - a + r) / (c + r);
            var p = t || (l - u + d) / (m + d);
            return n.options.center && (s = p = .5), l = o ? f(o, -10, 10) : n.options.speed, (t || n.options.center) && (l = f(o || n.options.speed, -5, 5)), t = h(p, s, l), e = e.style.cssText, o = "", 0 <= e.indexOf("transform") && (o = e.indexOf("transform"), o = e.slice(o), o = (s = o.indexOf(";")) ? " " + o.slice(11, s).replace(/\s/g, "") : " " + o.slice(11).replace(/\s/g, "")), {
                baseX: t.x,
                baseY: t.y,
                top: a,
                left: u,
            ...
            h = function (e, t, o) {
                var i = {};
                return e = 100 * o * (1 - e), t = 100 * o * (1 - t), i.x = n.options.round ? Math.round(e) : Math.round(100 * e) / 100, i.y = n.options.round ? Math.round(t) : Math.round(100 * t) / 100, i
            },
            g = function () {
                w() && !1 === a && y(), c(g)
            },
